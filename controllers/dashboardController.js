...
exports.getAssign = async (req, res) => {
    try {
        ...
        const businesses = await BusinessModel.find({}, "name subbusinesses").exec();
...
exports.getAssignValue = async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: "New Document added Successfully", checklistId });
    } catch (error) {
...
exports.updateUserChecklist = async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: "Document updated successfully", checklistId });
    } catch (error) {
