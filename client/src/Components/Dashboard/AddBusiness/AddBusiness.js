...
//phone
  const changeHandlePhone=(e, subBusinessIndex, buildingIndex, phoneIndex)=>{
    const {name, value}= e.target;
    const list= [...subBusinessList];
    list[subBusinessIndex].buildingList[buildingIndex].phoneList[phoneIndex].buildingPhone= value;
  ...
  const handleremovePhone= (subBusinessIndex, buildingIndex, phoneIndex)=>{
    const list=[...subBusinessList];
    list[subBusinessIndex].buildingList[buildingIndex].phoneList.splice(phoneIndex,1);
    setSubBusinessList(list);
  }
  ...
  //email
  const changeHandleEmail=(e, subBusinessIndex, buildingIndex, emailIndex)=>{
    // console.log("console value in email:", subBusinessIndex, buildingIndex, emailIndex)
    const {name, value}= e.target;
    const list = [...subBusinessList];
    // console.log("emillll",list[subBusinessIndex]);
    list[subBusinessIndex].buildingList[buildingIndex].emailList[emailIndex].buildingEmail = value;
    setSubBusinessList(list);
  }
 
  const handleremoveEmail= (subBusinessIndex, buildingIndex, emailIndex)=>{
    const list=[...subBusinessList];
    list[subBusinessIndex].buildingList[buildingIndex].emailList.splice(emailIndex,1);
    setSubBusinessList(list);
  }
  ...
  const createHandler = async (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      try {
        ...
        const response = await axios.post(`${process.env.REACT_APP_NODE_API}/api2/business`, businessData);
      ...
      <div className={businessStyle.business}>
        <form>
          ...
          <div className={businessStyle.remove_button}>
          {
                  ...
                  <button onClick={()=> handleremoveSubBusiness(subBusinessIndex)}>-</button>
               }
               </div>
          ...
          <input
            ...
            onChange={ (e)=>changeHandleSubBusiness(e,subBusinessIndex)}
          ...
          <div className={businessStyle.remove_button}>
          {
                  ...
                  <button onClick={()=> handleremoveBuilding(buildingIndex)}>-</button>
               }
               </div>
               <div className={businessStyle.add_button}>
               { subBusiness.buildingList.length-1===buildingIndex &&
               <button type="button" onClick={ ()=>handleaddclickBuilding(subBusinessIndex)}>+</button>
               }
               </div>
               </div>
               <div className={businessStyle.option}>
          ...
          <input
            ...
            onChange={ (e)=>changeHandleBuilding(e, subBusinessIndex, buildingIndex)}
          ...
          <input
            ...
            onChange={ (e)=>changeHandlePhone(e,subBusinessIndex, buildingIndex, phoneIndex)}
          ...
          <div className={businessStyle.remove_button}>
          {
                  ...
                  <button onClick={()=> handleremovePhone(subBusinessIndex, buildingIndex, phoneIndex)}>-</button>
               }
               </div>
               <div className={businessStyle.add_button}>
               { building.phoneList.length-1===phoneIndex &&
               <button onClick={ ()=>handleaddclickPhone(subBusinessIndex, buildingIndex)}>+</button>
               }
               </div>
               </div>
               </div>
          ...
          <input
            ...
            onChange={ (e)=>changeHandleEmail(e,subBusinessIndex, buildingIndex,
              emailIndex)}
          ...
          <div className={businessStyle.remove_button}>
          {
                  ...
                  <button onClick={()=> handleremoveEmail(subBusinessIndex, buildingIndex, emailIndex)}>-</button>
               }
               </div>
               <div className={businessStyle.add_button}>
               { building.emailList.length-1===emailIndex &&
               <button onClick={ ()=>handleaddclickEmail(subBusinessIndex, buildingIndex)}>+</button>
               }
               </div>
               </div>
               </div>
          ...
          />
          <p className={businessStyle.error}>{formErrors.buildingPostalCode}</p>
          </div>
          <div className={businessStyle.option}>
          ...
          />
          <p className={businessStyle.error}>{formErrors.buildingCity}</p>
          </div>
          <div className={businessStyle.option}>
          ...
          />
          <p className={businessStyle.error}>{formErrors.buildingState}</p>
          </div>
          <div className={businessStyle.option}>
          ...
          />
          <p className={businessStyle.error}>{formErrors.buildingCountry}</p>
          </div>
              </div>
          ))}
          </div>
