              ...
              <form onSubmit={handleSubmit}>
                {checklistData.sections?.map((section, index) => (
                  ...
                  >
                    ...
                    {/* <div className="form-header grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                      {section.questions?.map((question) => (
                          ...
                          <div className="flex rounded-md p-4">
                            {question.answerOptions?.filter(
                              ...
                              <div className="w-1/3 pr-4">
                                {" "}
                                {/* Set the width to half and add right padding */}
                                <p className="font-semibold text-xl my-2 text-black">
                                  {question.title}
                                </p>
                              </div>
